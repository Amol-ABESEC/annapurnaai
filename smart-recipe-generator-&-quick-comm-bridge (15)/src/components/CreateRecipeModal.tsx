...
import { ChefHat, X, Plus, Trash2, Clock, Users, Flame, Sparkles, Check } from 'lucide-react';
...
export const CreateRecipeModal: React.FC<CreateRecipeModalProps> = ({
  ...
  const [proteinGrams, setProteinGrams] = useState(18);
  const [carbsGrams, setCarbsGrams] = useState(22);
