...
import { Clock, ChefHat, ShoppingCart, Sparkles, AlertCircle, CheckCircle2, ChevronRight, Users, Flame, Search, X, Filter, Utensils, Play, Youtube, Heart, Calendar, Trash2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {filteredRecipes.length === 0 && (
        <div className="bg-[#181311] border border-[#2a221f] rounded-2xl p-10 text-center shadow-sm space-y-3">
          ...
          <h3 className="text-base font-bold font-serif text-white">No matching dishes found</h3>
      ...
      {filteredRecipes.length > displayLimit && (
        <div className="text-center pt-6 pb-2">
          ...
          >
            <span>Load More Recipes ({filteredRecipes.length - displayLimit} Remaining)</span>
